...
while DeseaContinuar == "si" or DeseaContinuar == "SI" or DeseaContinuar == "Si":
    ...
    # registro = None
    DeseaContinuar = input("Desea continuar ingresando Clientes? (Si/No) ")

for registro in listaRegistro:
    print(registro)

print("Los costos totales son: " + str(costoTotal))
